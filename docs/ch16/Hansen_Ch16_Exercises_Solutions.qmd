---
title: "Bruce Hansen《Econometrics》第 16 章习题解答"
subtitle: "Chapter 16 Non-Stationary Time Series"
...
- **代码：** R 实现（`scripts/r_companions/ch16.R`）**内联**于下文；数据在 `hansen/econometrics/data/`。
...
以下代码来自 `scripts/r_companions/ch16.R`（与 Python notebook 对应）。
...
*第 16 章 · R/Quarto · 理论 Markdown + R companion 融合*  
