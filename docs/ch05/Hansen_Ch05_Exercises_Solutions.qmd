...
- **代码：** R 实现（`scripts/r_companions/ch05.R`）**内联**于下文；数据在 `hansen/econometrics/data/`。
...
以下代码来自 `scripts/r_companions/ch05.R`（与 Python notebook 对应）。
...
*第 5 章 · R/Quarto · 理论 Markdown + R companion 融合*  
